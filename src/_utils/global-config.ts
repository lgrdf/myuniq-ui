...
const GLOBAL_CONFIG_NAME = '_myuniq'
const COMPONENT_PREFIX = 'S'
export interface MyuniqUIOptions {
  classPrefix?: string
...
export const setGlobalConfig = (
  app: App,
  options: MyuniqUIOptions = { classPrefix: CLASS_PREFIX }
) => {
...
// 获取组件name的prefix
export const getComponentPrefix = (options?: MyuniqUIOptions): string =>
